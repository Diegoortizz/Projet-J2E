...
CREATE TABLE DISCOUNT_CODE(
    DISCOUNT_CODE CHAR(1) PRIMARY KEY,
    RATE DECIMAL(4,2));

CREATE TABLE PRODUCT_CODE(
    PROD_CODE CHAR(2) PRIMARY KEY,
...
INSERT INTO MICRO_MARKET VALUES(95100,157.869,385.821,147.538);

INSERT INTO PRODUCT VALUES(1,666,'SW',175,800,25.00,TRUE,'Accounting Application');
INSERT INTO PRODUCT VALUES(2,999,'CB',13600,10,36.15,TRUE,'Sound Card');

INSERT INTO PRODUCT_CODE VALUES('SW','N','Software');
INSERT INTO PRODUCT_CODE VALUES('CB','P','Cables');

INSERT INTO PURCHASE_ORDER VALUES(22112018,10,1,1,263,2018-11-22,2018-11-22,'Colissimo');
INSERT INTO PURCHASE_ORDER VALUES(15092018,30,2,15,1500,2018-09-15,2018-09-15,'LaPoste');
